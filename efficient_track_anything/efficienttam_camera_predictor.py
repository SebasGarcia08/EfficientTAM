...
from efficient_track_anything.modeling.efficienttam_base import NO_OBJ_SCORE, EfficientTAMBase
from efficient_track_anything.utils.misc import concat_points, fill_holes_in_mask_scores


class EfficientTAMCameraPredictor(EfficientTAMBase):
    """The predictor class to handle real-time camera inputs and manage inference states."""
...
class EfficientTAMCameraPredictorVOS(EfficientTAMCameraPredictor):
