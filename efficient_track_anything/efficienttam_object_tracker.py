...
from efficient_track_anything.utils.kalman_filter import KalmanFilter
from efficient_track_anything.utils.misc import get_1d_sine_pe


class EfficientTAMObjectTracker(EfficientTAMBase):
    def __init__(self,
                 num_objects=10,
                 verbose=True,
                 samurai_mode=True,
